...
for source_file in app.py fleet_manager.py system_manager.py gst_base.py gst_ndi.py inferno_status.py ndi_runtime_config.py tvh.py config.example.json INSTALLER_VERSION; do
